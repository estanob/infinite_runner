...
Game.DIM_X = 1000;
Game.DIM_Y = 580;
Game.NUM_SHARKS = 100 * Math.random();
...
const GameView = function (game, ctx) {
  ...
  // this.sharks = this.game.addSharks();
...
MovingObject.prototype.move = function (delta) {
  ...
  if (this.game.isOutOfBounds(this.pos)) { // fix outofbounds
    this.vel[0] = this.vel[0]; //cause shark to change direction
