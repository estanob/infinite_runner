...
class Game {
  ...
  powerUp() {
    if ((this.icebergsHit >= (Game.NUM_ICEBERGS * .15)) && (this.icebergsHit < (Game.NUM_ICEBERGS * .2))) {
      this.powerDistance = 200;
    } else if ((this.icebergsHit >= (Game.NUM_ICEBERGS * .2)) && (this.icebergsHit < (Game.NUM_ICEBERGS * .35))) {
      this.powerDistance = 300;
    } else if ((this.icebergsHit >= (Game.NUM_ICEBERGS * .35)) && (this.icebergsHit < (Game.NUM_ICEBERGS * .75))) {
...
Game.DIM_Y = 550;
// Game.NUM_ICEBERGS = 8;
Game.NUM_ICEBERGS = Math.ceil((50 * Math.random()) * (10 * Math.random()));
...
GameView.prototype.start = function () {
  if (this.game.numIcebergs >= 50 && this.game.numIcebergs <= 800) {
