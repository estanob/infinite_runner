...
IceBerg.prototype.drawIceberg = function (ctx) {
  ctx.drawImage(this.icebergImg, 150, 250, 100, 100)
}
...
MovingObject.prototype.moveSurfer = function (delta, surferVel, surferPos) {
  // console.log("type of this", this instanceof Surfer)
  // console.log("Moving Object this", this)
  const vel = delta / TIME_DELTA;
  // console.log("velocity", this.vel)
  // const moveX = this.vel[0] * vel;
  // const moveY = this.vel[1] * vel;

  const moveX = surferVel[0] + vel;
  const moveY = surferVel[1] + vel;
  
  // console.log("first", this.pos)
  surferPos = [surferPos[0] + moveX, surferPos[1] + moveY];
  // this.pos = [this.pos[0] + moveX, this.pos[1] + moveY];
  // console.log("move x", moveX)
  // console.log("move Y", moveY)
  // console.log("second", this.pos)

  if (this.game.isOutOfBounds(surferPos)) {
    surferVel[0] = 0;
    surferVel[1] = 0;
  };
};
...
Surfer.prototype.drawSurfer = function (ctx) {
  console.log("draw surfer pos", this.pos)
...
Surfer.prototype.surf = function (impulse) {
  ...
  console.log("surf method", this.vel)
};
