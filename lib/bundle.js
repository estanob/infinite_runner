...
Game.DIM_Y = 580;
// Game.NUM_SHARKS = 20;
// Game.NUM_SHARKS = Math.round(50 + (100 * Math.random()));
Game.NUM_SHARKS = Math.round(((100 * Math.random()) * (10 * Math.random())));
// Game.NUM_SHARKS = Math.round((10 * Math.random()) * (10 * Math.random()));
Game.NUM_WAVES = 10;
...
Game.prototype.step = function (delta) {
  ...
  console.log(this)
  console.log("Number of Sharks");
  console.log(Game.NUM_SHARKS);
  console.log("How many sharks hit");
  console.log(this.sharksHit);
  console.log("Bending Power")
  console.log(this.powerDistance)
};
...
Game.prototype.powerUp = function () {
  if ((this.sharksHit >= (Game.NUM_SHARKS * .5)) && (this.sharksHit < (Game.NUM_WAVES * .75))) {
